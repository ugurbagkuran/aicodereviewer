// Shared app-shell tokens + reusable UI pieces for Login / Dashboard / Workspace
// Matches the landing aesthetic: editorial headlines, mono details, phosphor-green accent.
...
// Reusable logo mark — white square with "r"
const Logo = ({ size = 22, withWordmark = true, version = 'v0.3.1' }) => (
...
// Standard app top bar used across authed pages
const AppTopBar = ({ project, user = 'seda.k', children }) => (
  <div style={{
...
// Small chip
const Chip = ({ children, color = APP.dim, bg = 'transparent', border = APP.line, mono = true, style = {} }) => (
  <span style={{
...
// Dot indicator
const Dot = ({ color = APP.accent, size = 6, glow = true }) => (
  <span style={{
...
Object.assign(window, { APP, Logo, AppTopBar, Chip, Dot });
