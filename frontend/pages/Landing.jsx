...
import { APP } from '../tokens.jsx';
import { Magnetic, TextScramble, Reveal, Ticker, Marquee, Accordion, CursorGlow } from '../shared.jsx';
...
const c = {
  bg: '#0a0a0a', fg: '#ededed',
  dim: 'rgba(237,237,237,0.6)', faint: 'rgba(237,237,237,0.35)',
  line: 'rgba(255,255,255,0.08)', lineStrong: 'rgba(255,255,255,0.14)',
  accent: '#7dffb3', panel: '#0f1210',
};
...
const faqs = [
  ...
  { q: 'Fiyatlandırma nasıl?', a: 'Bireysel kullanım için ücretsiz, haftada 10 gözden geçirme. Ücretli planlar aylık $12\'den başlıyor. Erken erişim sırasında tüm planlar %50 indirim geçerli.' },
];
    ...
    <div style={{
      ...
      <section ref={heroRef} style={{
            ...
            <div>
              <Reveal delay={60}>
                <h1 style={{
                  ...
                  AI, kodunu{' '}
                  <span style={{ fontStyle: 'italic', fontWeight: 300, opacity: 0.65 }}>senin gibi</span>
              ...
              <div style={{
                ...
                <div style={{ padding: '18px 18px 14px', minHeight: 360, fontSize: 13, lineHeight: 1.75 }}>
                  {terminalLines.slice(0, Math.min(tickIdx + 1, terminalLines.length)).map((l, i) => (
                    <div key={i} style={{ color: kindColor(l.k), whiteSpace: 'pre-wrap' }}>{l.t}</div>
                  ))}
        ...
        <div style={{
          ...
          margin: '100px auto 0', maxWidth: 1400, width: '100%',
            ...
            {[
              ...
              <div key={col.h}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                  {col.items.map((item) => (
                    <a key={item} href="#" style={{ color: c.dim, textDecoration: 'none', fontSize: 14 }}
                      onMouseEnter={(e) => (e.currentTarget.style.color = c.fg)}
                      onMouseLeave={(e) => (e.currentTarget.style.color = c.dim)}>
                      <TextScramble text={item} duration={350} />
                    </a>
                  ))}
                </div>
              </div>
